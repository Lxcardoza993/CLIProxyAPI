...
func TestBuildImagesResponsesRequest_DoesNotForceToolChoice(t *testing.T) {
	body := buildImagesResponsesRequest("draw an apple", nil, []byte(`{"type":"image_generation","model":"gpt-image-2","size":"1024x1024"}`))
